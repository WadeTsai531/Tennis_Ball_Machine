...
class Control_GUI:
    ...
    def Start_GUI(self, window, x=0, y=0):
        ...
        self.Rotate_Calibration_Button.place(x=10, y=495)
...
class Main:
    def __init__(self):
        ...
        # -------- Control Plane --------
        control_x, control_y, control_w, control_h = 651, 160, 295, 270
