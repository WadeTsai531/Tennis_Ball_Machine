...
class Main_GUI:
    ...
    def Tracking(self, frame):
        ...
        for label, confidence, bbox in detections:
            if label == 'person':
                relative_bbox = self.convert2relative(bbox, self.darknet_width, self.darknet_height)
                new_bbox = self.convert2original(frame, relative_bbox)
                # ---- trt ----
    ...
    def convert2relative(self, bbox, width, height):
        """
